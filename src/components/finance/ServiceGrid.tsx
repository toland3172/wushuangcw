...
const SERVICES = [
  ...
  },
  {
    ...
    items: ['税务健康检查与预警（含风险排查、预警提示、稽查应对）', '纳税申报协助', '汇算清缴辅导', '税收优惠政策申请', '税务筹划', '个人所得税筹划', '研发费用加计扣除'],
  },
  {
    icon: '📊',
    title: '财务咨询',
    tagline: '适合需要规范化、拟上市或融资的企业',
    items: ['财务制度建设', '财务分析', '成本核算优化', '内控体系建设', '股权架构与顶层设计（初始股权架构设计、股权激励方案、股权重组优化、家族财富传承）', '财务人员培训', '投资决策支持', '上市财务顾问'],
  },
  {
    icon: '🌐',
    title: '香港公司服务',
  ...
  },
  {
    ...
    items: ['高新技术企业认定辅导', '研发费用归集辅导', 'IPO前期合规辅导', '财务尽职调查·含投资/并购尽调（为投资、并购、IPO等场景提供财务尽调与风险评估）'],
  },
  {
    icon: '📚',
    title: '培训与赋能',
